...
def main(args):
    ...
    elif args.image_model == "clippit":
        model = clipsep.CLIPPITSep(
            args.n_mix,
            args.layers,
            args.channels,
            use_log_freq=args.log_freq,
    ...
    elif args.image_model == "clippit4":
    ...
    # Start evaluation
    if args.audio_only or args.image_model in ("label_only", "pit"):
        test_modes = ["text"]
    elif args.image_model == "sop":
        test_modes = ["image"]
    else:
...
if __name__ == "__main__":
    ...
    if args.vis_dir is None:
        args.vis_dir = args.out_dir / "visualization"
    args.vis_dir.mkdir(exist_ok=True)
